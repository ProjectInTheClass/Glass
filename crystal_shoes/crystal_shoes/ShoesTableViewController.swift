...
class ShoesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        /*
        cell.textLabel?.text = shoes_1[indexPath.row].title
        cell.detailTextLabel?.text = shoes_1[indexPath.row].shoestype
        cell.imageView?.image = UIImage(named: shoes_1[indexPath.row].imageName)
 */
        cell.shoesForCell = shoes_1[indexPath.row]
        return cell
    }
